...
-- -----------------------------------------------------
-- Table `sfm`.`interest_rate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sfm`.`interest_rate` ;

CREATE TABLE IF NOT EXISTS `sfm`.`interest_rate` (
...
-- -----------------------------------------------------
-- Table `sfm`.`retake_course_payment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sfm`.`retake_course_payment` ;

CREATE TABLE IF NOT EXISTS `sfm`.`retake_course_payment` (
  `RetakeCoursePaymentID` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  `Note` TEXT NULL DEFAULT NULL,
  `IsActive` BIT(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`RetakeCoursePaymentID`),
...
CREATE TABLE IF NOT EXISTS `sfm`.`tuition_plan` (
  ...
  INDEX `fk_plan_season_idx` (`TermID` ASC),
  CONSTRAINT `fk_plan_season`
    FOREIGN KEY (`TermID`)
    REFERENCES `sfm`.`term` (`TermID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
